...
pygame.display.set_caption("Dijkstra's Path Finding Algorithm Visualisation :) ")
    ...
    while True:
        ...
        for i in range(cols):
            for j in range(rows):
                ...
                if spot in path:
                    spot.show(win, (128, 0, 128))
                    spot.show(win, (128, 0, 128), 0)
                elif spot.visited:
                ...
                if spot == start:
                    spot.show(win, (255, 165, 0))
                if spot == end:
                    spot.show(win, (64, 224, 208))
